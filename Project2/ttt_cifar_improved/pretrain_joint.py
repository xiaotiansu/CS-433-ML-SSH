...
def parse_option():
    ...
    parser.add_argument('--data_folder', type=str, default='/data/wilds', help='path to custom dataset')
    ...
    # variable
    parser.add_argument('--trainable', type=str, default='head',
...
def set_model(opt):
    ...
    model = JointResNet(name=opt.model, num_classes=opt.n_cls)
